...
serve(async (req) => {
  ...
  try {
    ...
    const {
      nombre_establecimiento, correo_contacto, nombre_contacto,
      tipo_negocio, ciudad, instagram,
    } = record;
  ...
  <table width="100%" cellpadding="0" cellspacing="0" style="background:#f5f5f5;padding:32px 0;">
    <tr><td align="center">
      <table width="600" cellpadding="0" cellspacing="0" style="max-width:600px;width:100%;background:#ffffff;border-radius:16px;overflow:hidden;box-shadow:0 2px 16px rgba(0,0,0,0.08);">
        ...
        <tr>
          <td style="padding:0;">
            <img src="https://asobares.org/wp-content/uploads/2026/08/Banner-forms-3-scaled.jpg" alt="Guía Gastroentretenimiento Armenia" style="width:100%;display:block;" />
          </td>
        </tr>
        ...
        <tr>
          <td style="padding:40px 40px 8px;text-align:center;">
            ...
            <p style="margin:6px 0 0;font-size:16px;font-weight:700;color:#1a1a1a;">
              ${nombre_establecimiento || nombre_contacto}
            </p>
          </td>
        </tr>
        ...
        <tr>
          <td style="padding:24px 40px 32px;">
            <p style="margin:0 0 20px;font-size:15px;color:#475569;line-height:1.7;text-align:center;">
              El establecimiento ha sido inscrito exitosamente en la <strong>Guía de Establecimientos de Gastroentretenimiento de Armenia</strong>, un proyecto de la Alcaldía de Armenia, Quindío Convention Bureau y Asobares Colombia.
            </p>
              ...
              <tr>
                <td style="padding:20px 24px;">
                  ...
                  <table width="100%" cellpadding="0" cellspacing="0">
                    ...
                    ${ciudad ? `<tr><td style="padding:8px 0;border-bottom:1px solid #e8f5e9;"><span style="font-size:12px;color:#64748b;">CIUDAD</span><br/><span style="font-size:14px;color:#1a2e1a;font-weight:600;">${ciudad}</span></td></tr>` : ''}
                    ${instagram ? `<tr><td style="padding:8px 0;"><span style="font-size:12px;color:#64748b;">INSTAGRAM</span><br/><span style="font-size:14px;color:#1a2e1a;font-weight:600;">${instagram}</span></td></tr>` : ''}
                  </table>
                </td>
              </tr>
            </table>
            ...
            <p style="margin:0 0 8px;font-size:15px;color:#475569;text-align:center;line-height:1.6;">
              Pronto nuestro equipo revisará los documentos y se pondrá en contacto con usted.
            </p>
    ...
    formBody.append('to', correo_contacto);
    formBody.append('subject', '¡Inscripción recibida! Guía de Gastroentretenimiento — Armenia');
